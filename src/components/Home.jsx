    ...
    <>
      ...
      <div className="">
        <section className="text-left">
          ...
          <p id='home-para1' className='text-lg mt-6 text-deepGrey font-medium'> I am a frontend engineer and I enjoy creating responsive and adequate front-end products. <br /> 
              Being a critical thinker, I love solving problems. I am passionate about learning, I am curious, versatile and trying out new techs gives me thrills.</p>
