...
const Home = () => {
	...
	return (
			...
			<motion.section variants={container} initial="hidden" animate="visible">
				...
				<motion.h1
					variants={item}
					className="text-4xl md:text-7xl mt-6 font-bold text-lightGrey"
				>
					Tobi Adesanya.
				</motion.h1>
				<motion.h2
				...
				>
					...
					Being a critical thinker, solving problems intrigues me. I am
					passionate about learning and trying out new techs gives me thrills.
				</motion.p>
