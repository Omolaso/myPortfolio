            ...
            <Card className="w-full mx-auto max-w-4xl">
              ...
              <CardContent className="bg-black">
                <Typography variant="header" component="div">
                  <h2 className="flex flex-row gap-2 items-center justify-center text-xl text-lightGrey font-bold text-center">
                    <span>{item.name}</span>
                    <span
                      className={
                        item.featured
                ...
                <Typography variant="div" color="text.secondary">
                  ...
                  <div className="flex flex-row items-center justify-around mx-auto text-lightGrey text-xs w-full max-w-xs mt-3">
